...
def extract_positives_negatives(input_path: str, output_path: str) -> None:
    ...
    for gid, group in grouped.items():
        if len(group) != 20: # Not valid if under 20 statements
            continue
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Label to use instead of the original run-name.",
    )
